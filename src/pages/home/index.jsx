...
function Home() {
  ...
  return (
    <Page>
        ...
        <PageBody >
            <SidePanel>
                <Sorting title="Sorting" data={sortingOptions} value={selectedSorting} onChange={(val)=>setSelectedSorting(val)}/>                  
                <Brands title="Brands" data={companies} value={selectedBrands} onChange={(val)=>handleSelectBrand(val)}/>    
                <Tags title="Tags" data={tags} value={selectedTags} onChange={(val)=>handleSelectTag(val)}/>                                   
            </SidePanel>
            <MainPanel>              
                <Products data={filteredData} itemCount={16} relatedTypes={relatedTypes} selectedTypes={selectedTypes} selectType={(val)=>onSelectType(val)}/>
            </MainPanel>
            <SidePanel>
                <Basket />  
            </SidePanel>
